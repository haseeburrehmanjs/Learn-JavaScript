...
var obtain = +(math + Islamiyat + Physices + Science)
var totalNumber = 500;

console.log(obtain);
console.log(totalNumber);
console.log(obtain/totalNumber*100);

var Math = "Math Total marks"
var Science = "Science Total marks"
var Physices = "Physices Total marks"
var Chemistry = "Math Total marks"

console.log(); obtain = (math + Science + Physices + Chemistry)
var totalNum = 500

console.log(botain/totalNum*100);
...
var obtainNumber = +(math + Science + Biology + Physices + Computer);
var totalNumber = 500;

console.log(obtainNumber);
console.log(500);
...
let softweree = ['Vs code', 'PhotoShop', 'Antivirus', 'Figma']
let textArray = softweree.join(' ')
...
let softwereee = ['Illustartor', 'Photoshop', 'figma', 'indesgin']

let arraytwo = ['jawad', 'haseeb']
softwereee.push('Indesign')
softwereee.pop(' ')

softwereee.shift('')
softwereee.shift('')

softwereee.splice(1 , 1 , 'capcut')

text = softwereee.split(" ")

console.log(text);

arraythree = softwereee.concat(arraytwo)

console.log(softwere);

let softwereOne = ['Illustartor', 'Photoshop', 'figma', 'indesgin']
...
function MySoft(){
    console.log(input.value);
    if(softwereOne.includes(input.value)){
        console.log(input.value);
